...
RSpec.describe SolarTerms24::SolarTerms do
  ...
  describe '#initialize' do
    ...
    context 'when the year is not cached' do
      let(:data) do
        {
      ...
      it 'call Cache.save the year does not exist' do
        expect(SolarTerms24::Cache).to receive(:has?).and_return(false)
        expect(SolarTerms24::Horizons).to receive(:find_solar_terms_times).with(2022).and_return(data)
        expect(SolarTerms24::Cache).to receive(:save).with(2022, data)
        solar_terms
      end
    end
  ...
  describe 'can call each solar term' do
    it do
      ...
      expect(solar_terms.minor_cold.time.strftime('%Y-%m-%d %H:%M:%S')).to eq('2022-01-05 09:14:04')
      ...
      expect(solar_terms.major_cold.time.strftime('%Y-%m-%d %H:%M:%S')).to eq('2022-01-20 02:39:08')
      ...
      expect(solar_terms.start_of_spring.time.strftime('%Y-%m-%d %H:%M:%S')).to eq('2022-02-03 20:50:48')
      ...
      expect(solar_terms.spring_showers.time.strftime('%Y-%m-%d %H:%M:%S')).to eq('2022-02-18 16:43:02')
      ...
      expect(solar_terms.grain_rain.time.strftime('%Y-%m-%d %H:%M:%S')).to eq('2022-04-20 02:24:17')
      ...
      expect(solar_terms.start_of_summer.time.strftime('%Y-%m-%d %H:%M:%S')).to eq('2022-05-05 12:25:58')
      ...
      expect(solar_terms.grain_buds.time.strftime('%Y-%m-%d %H:%M:%S')).to eq('2022-05-21 01:22:35')
      ...
      expect(solar_terms.grain_in_ear.time.strftime('%Y-%m-%d %H:%M:%S')).to eq('2022-06-05 16:25:49')
      ...
      expect(solar_terms.summer_solstice.time.strftime('%Y-%m-%d %H:%M:%S')).to eq('2022-06-21 09:13:52')
      ...
      expect(solar_terms.minor_heat.time.strftime('%Y-%m-%d %H:%M:%S')).to eq('2022-07-07 02:38:01')
      ...
      expect(solar_terms.major_heat.time.strftime('%Y-%m-%d %H:%M:%S')).to eq('2022-07-22 20:07:00')
      ...
      expect(solar_terms.start_of_autumn.time.strftime('%Y-%m-%d %H:%M:%S')).to eq('2022-08-07 12:29:10')
      ...
      expect(solar_terms.end_of_heat.time.strftime('%Y-%m-%d %H:%M:%S')).to eq('2022-08-23 03:16:11')
      ...
      expect(solar_terms.white_dew.time.strftime('%Y-%m-%d %H:%M:%S')).to eq('2022-09-07 15:32:19')
      ...
      expect(solar_terms.autumn_equinox.time.strftime('%Y-%m-%d %H:%M:%S')).to eq('2022-09-23 01:03:43')
      ...
      expect(solar_terms.cold_dew.time.strftime('%Y-%m-%d %H:%M:%S')).to eq('2022-10-08 07:22:28')
      expect(solar_terms.frost.is_a?(SolarTerms24::SolarTerm)).to be_truthy
      expect(solar_terms.frost.solar_term_key).to eq(:frost)
      expect(solar_terms.frost.time.strftime('%Y-%m-%d %H:%M:%S')).to eq('2022-10-23 10:35:43')
      ...
      expect(solar_terms.start_of_winter.time.strftime('%Y-%m-%d %H:%M:%S')).to eq('2022-11-07 10:45:30')
      ...
      expect(solar_terms.minor_snow.time.strftime('%Y-%m-%d %H:%M:%S')).to eq('2022-11-22 08:20:30')
      ...
      expect(solar_terms.major_snow.time.strftime('%Y-%m-%d %H:%M:%S')).to eq('2022-12-07 03:46:16')
      ...
      expect(solar_terms.winter_solstice.time.strftime('%Y-%m-%d %H:%M:%S')).to eq('2022-12-21 21:48:14')
    end
  end
  ...
  describe '#dates' do
    it 'returns solar term dates' do
      ...
      expect(dates[5]).to eq(Date.new(2022, 3, 20))
      expect(dates[6]).to eq(Date.new(2022, 4, 4))
      expect(dates[7]).to eq(Date.new(2022, 4, 20))
      expect(dates[8]).to eq(Date.new(2022, 5, 5))
      expect(dates[9]).to eq(Date.new(2022, 5, 21))
      expect(dates[10]).to eq(Date.new(2022, 6, 5))
      expect(dates[11]).to eq(Date.new(2022, 6, 21))
