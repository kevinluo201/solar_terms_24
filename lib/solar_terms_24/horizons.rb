...
module SolarTerms24
  ...
  module Horizons
    ...
    SOLAR_TERMS = {
      minor_cold: { month: 1, days: 4..7, longitude: 285 },
      major_cold: { month: 1, days: 19..21, longitude: 300 },
      start_of_spring: { month: 2, days: 3..5, longitude: 315 },
      spring_showers: { month: 2, days: 17..20, longitude: 330 },
      awakening_of_insects: { month: 3, days: 4..7, longitude: 345 },
      spring_equinox: { month: 3, days: 19..22, longitude: 0 },
      pure_brightness: { month: 4, days: 3..6, longitude: 15 },
      grain_rain: { month: 4, days: 19..21, longitude: 30 },
      start_of_summer: { month: 5, days: 4..7, longitude: 45 },
      grain_buds: { month: 5, days: 19..22, longitude: 60 },
      grain_in_ear: { month: 6, days: 4..7, longitude: 75 },
      summer_solstice: { month: 6, days: 20..22, longitude: 90 },
      minor_heat: { month: 7, days: 5..8, longitude: 105 },
      major_heat: { month: 7, days: 21..24, longitude: 120 },
      start_of_autumn: { month: 8, days: 6..9, longitude: 135 },
      end_of_heat: { month: 8, days: 22..24, longitude: 150 },
      white_dew: { month: 9, days: 6..9, longitude: 165 },
      autumn_equinox: { month: 9, days: 21..24, longitude: 180 },
      cold_dew: { month: 10, days: 7..9, longitude: 195 },
      frost: { month: 10, days: 22..24, longitude: 210 },
      start_of_winter: { month: 11, days: 6..9, longitude: 225 },
      minor_snow: { month: 11, days: 21..23, longitude: 240 },
      major_snow: { month: 12, days: 6..8, longitude: 255 },
      winter_solstice: { month: 12, days: 20..23, longitude: 270 }
    }.freeze

    class << self
      def find_solar_terms_times(year)
        whole_year_data = fetch_ecliptic_longitudes(Date.new(year, 1, 4), Date.new(year, 12, 23), step: '1 hour')
